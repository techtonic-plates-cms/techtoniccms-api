        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedStringValue = table.Column<string>(type: "text", nullable: true),
                    ExpectedNumberValue = table.Column<double>(type: "double precision", nullable: true),
                    ExpectedBooleanValue = table.Column<bool>(type: "boolean", nullable: true),
                    ExpectedUuidValue = table.Column<Guid>(type: "uuid", nullable: true),
                    ExpectedDateTimeValue = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExpectedArrayValue = table.Column<string[]>(type: "text[]", nullable: true),
                    ContextReferencePath = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlreadyExecuted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
